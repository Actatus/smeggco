			...
			<div class = 'container-fluid'>
				<div class = 'row'>
					...
					<div class = 'col-lg-8 jumbotron'>
						<div class = 'blog_post innards'>
							<p class = 'text-center'> Welcome to SmeggCo, home of things that interest us and, hopefully, you! Check out our featured podcasts over in the sidebar, or browse our collection of awesome articles about movies, games, and general geekery! </p>
						</div>
					</div>
					<div class = 'col-lg-2'></div>
				</div>
